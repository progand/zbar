...
(function($){
    ...
    return this.each(function(i){
        var self=$(this),isshow=false,opacity=options.opacity,container=$(options.container),offset=container.offset(),height=container.height()+((offset !=null )?offset.top:0),fx=options.fx||jQuery.easing.def||'linear';
        mouseover={},mouseout={};
        ...
        $(window).scroll(function(){
            var $this=$(this),top=$this.scrollTop();
            if(!isshow){
...
$('a',self).hover(function(){
    $(this).stop().animate(mouseover,options.speed).find('img').css('opacity',1);
},function(){
    $(this).stop().animate(mouseout,options.speed).find('img').css('opacity',opacity);
});
});
};
